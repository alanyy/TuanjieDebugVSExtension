...
namespace TuanjieDebugVSExtension
{
    internal class UnityProbe
    {
        ...
        public static IEnumerable<UnityProcess> GetUnityProcesses(
          string informationFormat = null)
        {
          return SafeProcess.GetProcesses().Where<Process>((Func<Process, bool>) (p => p.ProcessProperty<string>((Func<Process, string>) (_ => _.ProcessName)) == "Tuanjie")).Select<Process, UnityProcess>((Func<Process, UnityProcess>) (p => UnityProcessFor(p, informationFormat)));
        }
